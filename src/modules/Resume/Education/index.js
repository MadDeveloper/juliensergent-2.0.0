    ...
    <Layout.Content>
      ...
      <section className={styles.experiences}>
          ...
          description={
            <Fragment>
              <Typography.Paragraph>
                <Typography.Text>
                  I was formed to manage and lead a project with the agile
                  method (scrum or kanban), to create and manage a company, and
                  some languages and tools like C#, .NET Core, Angular, and
                  Robotics.
                </Typography.Text>
              </Typography.Paragraph>
              <Typography.Paragraph>
        ...
        <Experience
          ...
          description={
            <Fragment>
              ...
              <Typography.Paragraph>
                <Typography.Text>
                  Some languages and tools used: C, C++, C#, Python, PHP,
                  Symfony, JavaScript, AngularJS, Lisp, AngularJS, Java, Cisco,
                  Oracle.
                </Typography.Text>
              </Typography.Paragraph>
              <Typography.Paragraph>
                <Typography.Text>
                  I also learned all basics algorithms like binary tree,
                  Dijkstra, and a lot of mathematics.
                </Typography.Text>
              </Typography.Paragraph>
              <Typography.Paragraph>
                <Typography.Text>
        ...
        <Experience
          ...
          extraInfos={
            <ExtraInfos date="2012 - 2013" location="Cahors, France" />
          }
          description={
            <Typography.Text>
              I graduated highschool, where I enjoyed doing science,
              mathematics, biology, with a specialization in mathematics.
            </Typography.Text>
          }
        />
      </section>
