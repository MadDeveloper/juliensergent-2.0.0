          ...
          description={
            <Fragment>
              <Typography.Paragraph>
                <Typography.Text>
                  Integration in a small tech team, with a web fullstack role.
                  Maintenance and evolution of the DXPOne web app, which is the
                  main product sold by the company. In parallel, my job is to
                  develop client custom applications, which can be any kind of
                  application deployed in store (interactive table, kiosk, wall
                  of screens, ...). I was in charge to create from scratch the
                  mobile DXPOne platform app.
                  <br />
                  Obtained a Scrum Master certification and taking on the role
                  of Scrum Master within the team.
                </Typography.Text>
              </Typography.Paragraph>
              <Typography.Paragraph>
                <Typography.Text>
            ...
            <Fragment>
              <Typography.Paragraph>
                <Typography.Text>
                  ...
                  GraphQL. Agile methodology (here, scrum) is used as the
                  running framework. Discover of the startup company context.
                </Typography.Text>
              </Typography.Paragraph>
              <Typography.Paragraph>
                <Typography.Text bold>Technologies</Typography.Text>
        ...
        <Experience
          ...
          description={
            <Fragment>
              <Typography.Paragraph>
                <Typography.Text>
                  Development of a Facebook application, to make match two
                  persons as twins after a quiz. Ability to share your results
                  on your Facebook profile or by message.
                </Typography.Text>
              </Typography.Paragraph>
              <Typography.Paragraph>
                <Typography.Text bold>Technologies</Typography.Text>
